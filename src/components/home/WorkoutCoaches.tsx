      ...
      <div className="mx-auto max-w-[1400px]">
        ...
        <div className="mt-14 grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3">
          ...
          <div className="flex flex-col items-center justify-center px-4 py-12 text-center sm:col-span-2 lg:col-span-1 lg:py-0">
            <p className="font-[family-name:var(--font-barlow-condensed)] text-4xl font-bold text-neon md:text-5xl">
              Have 150+
            </p>
            <p className="mt-3 max-w-[220px] text-sm leading-relaxed text-white">
              Profesional Trainer and type of exercises
            </p>
            <Link
              href="#coaches"
              className="mt-8 inline-flex min-h-[44px] min-w-[140px] items-center justify-center rounded-full border border-white px-8 text-xs font-bold uppercase tracking-widest text-white transition-colors hover:bg-white hover:text-black focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2 focus-visible:ring-offset-black"
            >
              See More
            </Link>
          </div>
